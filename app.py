...
def extract_emails(output):
    # Implementa la lógica para extraer correos electrónicos de la salida
    emails = []
...
def extract_ips(output):
    # Implementa la lógica para extraer IPs de la salida
    ips = []
...
def theharvester():
    ...
    try:
        ...
        harvester_path = 'C:\\Users\\Ricardo\\Documents\\SeguridadInformatica\\theHarvester\\theHarvester.py' ###cambiar tu ruta del theHarvester
    ...
    return render_template('resultTheHarvester.html', emails=emails, ips=ips)
